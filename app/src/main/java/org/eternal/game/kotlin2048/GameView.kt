...
const val NUM_OF_RECTS = 4
const val GAP = 20F

// Background
const val BACKGROUND_SIZE = GAP * 5 + RECT_UNIT_SIZE * NUM_OF_RECTS
const val BACKGROUND_RADIUS = 20F

// View
const val VIEW_SIZE = BACKGROUND_SIZE

class GameView(context: Context, scoreView: TextView) : BaseView(context) {
    ...
    val unitManager = UnitManager(this@GameView, context, scoreView)
    init {
